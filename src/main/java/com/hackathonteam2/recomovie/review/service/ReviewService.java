...
public class ReviewService {
	...
	public List<Review> getAllReviews() {
		...
		reviews.sort((i, j) -> Long.compare(j.getReviewId(), i.getReviewId()));
		return reviews;
	}
	...
	public void writeReview(String loginId, ReviewRequest request) {
		...
		Cinema cinema = cinemaRepository.findByBrandAndRegionAndName(request.getBrand(), request.getRegion(),
			request.getCinema()).get();
